...
ticketWrapper.getElementsByClassName(
  "ticket__details ticket__title"
)[0].textContent = tickets.currentBuy["data-film-name"];
...
)[0].textContent = tickets.currentBuy["data-hall-name"].substr(
  tickets.currentBuy["data-hall-name"].length - 1
);
ticketWrapper.getElementsByClassName(
  "ticket__details ticket__start"
)[0].textContent = tickets.currentBuy["data-seance-time"];
ticketWrapper.getElementsByClassName(
  "ticket__details ticket__cost"
)[0].textContent = tickets.currentBuy["cost"];
